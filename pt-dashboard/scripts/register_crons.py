...
SUBSCRIPTION_PROMPT = (
    ...
    "and then mark it pending again, so tomorrow's run finds it. Then record "
    "the edition in the owner's wiki with record_edition.py (pt-edition's "
    "step 4) -- whatever it prints, the delivery and the mark stand. Final "
...
def daily_prompt(lock_name, live=False):
    ...
    return (
        ...
        f"Then record the edition in the owner's wiki with record_edition.py "
        f"(pt-edition's step 4) -- whatever it prints, the delivery and the "
        f"marks stand. Release the lock "
...
def paper_prompt(lock_name, hour):
    ...
    return (
        ...
        f"Do not mark desks. Do not mark assignments. "
        f"Then record the edition in the owner's wiki with record_edition.py "
        f"(pt-edition's step 4) -- whatever it prints, the delivery and the "
        f"marks stand. Release the lock "
        f"with /var/lib/hermes/skills/pt-shared/scripts/run_lock.py release "
