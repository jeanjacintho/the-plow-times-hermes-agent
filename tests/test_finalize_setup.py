...
class TestWritesAValidConfig:
    ...
    @pytest.mark.parametrize(("hour", "lead"), [("07:00", 300), ("00:20", 300)])
    def test_priority_lead_minutes(self, tmp_path, hour, lead):
        # The lead is the window pt-priority fills with research. The nominal lead is stored
        # unclamped -- 00:20 keeps its 300 here and registration clamps it per slot.
