...
class TestSkills:
    ...
    def test_priority_evolution_contract(self):
        ...
        for clause in (
            ...
            "A generation is not complete until its renderer exits zero",
            "Never defer a generation's candidate gate",
            "Do not start the next generation until the accepted checkpoint is published",
