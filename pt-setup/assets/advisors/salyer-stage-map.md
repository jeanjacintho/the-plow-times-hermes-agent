...
Read this each morning with the advisor's Q&A on the company (`~/Plow/wiki/synthesis/patrick-salyer-qa.md`), then place the company in one
...
- Discovery ($0–1M ARR): reaching product-market fit — a painkiller product and 5–10 referenceable customers.
- Blueprint ($1–10M ARR): building a repeatable go-to-market motion — a founder-written playbook that reps can hit.
- Scale ($10M+ ARR, toward $100M): perfecting the ramp model so the machine runs without the founder.
- Pivot (any ARR): the company or its business model is under acute threat.
- Fundraising (any stage): read alongside the stage while the owner is raising.

## Stage signals
- Discovery: under $1M ARR; fewer than about 5 referenceable customers; the founder does all the selling, implementation and support; no repeatable playbook.
- Blueprint: $1–10M ARR; 5–10+ referenceable customers; first reps hired; a written playbook emerging; testing whether reps, not just the founder, can close.
...
- If the owner is raising now, or plans to in the next 1–2 quarters, keep the stage and add Fundraising.
